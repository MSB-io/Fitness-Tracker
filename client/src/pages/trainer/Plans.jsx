...
const Plans = () => {
  ...
  const planTemplates = {
    weightLoss: {
      ...
      description:
        "A comprehensive 12-week program designed to help you lose weight through a balanced approach of cardio, strength training, and calorie-controlled nutrition.",
      dailyCalorieTarget: 1500,
      dailyProteinTarget: 120,
      notes:
        "Focus on maintaining a calorie deficit while preserving muscle mass. Drink plenty of water and get adequate sleep.",
      workoutPlan: [
        {
          day: "monday",
          exercises: [
            {
              ...
              reps: 1,
              duration: 30,
              notes: "Warm up 5 min, then intervals",
            },
          ...
          meals: [
            ...
            },
            {
              ...
              suggestions: [
                ...
                "Dal with vegetables and small roti",
              ],
            },
          ],
        },
    ...
    muscleGain: {
      ...
      description:
        "An intensive 12-week program focused on building lean muscle mass through progressive overload training and high-protein nutrition.",
      dailyCalorieTarget: 2500,
      dailyProteinTarget: 180,
      notes:
        "Focus on progressive overload. Increase weights gradually. Ensure 7-8 hours of sleep for recovery.",
      workoutPlan: [
        {
          day: "monday",
          exercises: [
          ...
          exercises: [
            {
              ...
              sets: 3,
              reps: 15,
              notes: "Light weights, high volume",
            },
            {
              name: "Core Workout",
              sets: 4,
          ...
          meals: [
            {
              ...
              targetCalories: 600,
              suggestions: [
                "6 egg whites with oats and banana",
            ...
            },
            {
              ...
              suggestions: [
                ...
                "Fish with brown rice and dal",
                "Paneer with quinoa and salad",
              ],
            },
            {
              type: "snack",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await trainerService.createPlan({
        ...formData,
        dailyCalorieTarget:
          Number.parseInt(formData.dailyCalorieTarget) || undefined,
        dailyProteinTarget:
          Number.parseInt(formData.dailyProteinTarget) || undefined,
      });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted">
            Create and manage training plans for your clients
          </p>
        </div>
        <Button
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 mb-2">
              ...
              >
                ...
                <div className="text-xs text-muted">
                  12-week program with cardio & nutrition
                </div>
              </button>
              <button
                type="button"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({ ...formData, dailyProteinTarget: e.target.value })
              }
              placeholder="e.g., 150"
            />
          </div>
